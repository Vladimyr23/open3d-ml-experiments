...
# File from https://github.com/WeikaiTan/RandLA-Net/tree/master
class Toronto3D:
    ...
    def load_sub_sampled_clouds(self, sub_grid_size, mode):
        ...
        for i, file_path in enumerate(files):
            ...
            kd_tree_file = join(self.path, '{:s}_KDTree.pkl'.format(cloud_name)) #VY tree_path replaced with self.path
            sub_ply_file = join(self.path, '{:s}.ply'.format(cloud_name)) #VY tree_path replaced with self.path
            ...
            if cloud_split == 'test':
                ...
                sub_labels = self.label_values #VY data['class'] replaced with self.label_values

            # # Read pkl with search tree #VY fragment commented out
